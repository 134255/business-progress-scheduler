...
const tasks = [
  ...
  ["T006", "用户、权限与业务线", "用户初始化与资料维护", d(8, 10), d(8, 10), "后端开发", "T005", "用户模块", "OpenID 唯一建档且状态可控", "未开始", "P0"],
  ["T007", "用户、权限与业务线", "业务线创建与唯一编号", d(8, 10), d(8, 11), "全栈开发", "T006", "创建页面/API", "可创建含至少一个节点的业务线", "未开始", "P0"],
  ["T008", "用户、权限与业务线", "业务线列表、详情与分页", d(8, 11), d(8, 12), "前端开发", "T007", "列表与详情", "成员只能看到关联业务", "未开始", "P0"],
  ["T009", "用户、权限与业务线", "业务线编辑与版本控制", d(8, 12), d(8, 13), "全栈开发", "T007", "编辑能力", "并发更新不覆盖他人改动", "未开始", "P0"],
  ["T010", "用户、权限与业务线", "管理员逻辑删除与审计", d(8, 13), d(8, 14), "后端开发", "T009", "删除/审计", "非管理员请求被拒绝并留痕", "未开始", "P0"],
  ...
  ["T029", "质量与安全", "云函数单元与集成测试", d(9, 14), d(9, 16), "QA/后端", "T023,T028", "自动化测试", "核心权限和状态机覆盖率达标", "未开始", "P0"],
